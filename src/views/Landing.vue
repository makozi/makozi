<template>
    <div>
        ...
        <section class="section section-lg pt-lg-0 section-contact-us">
            ...
            <div class="container">
<!--                 
                 <form id="form" accept-charset="UTF-8" action="https://usebasin.com/f/847ae8a4e61f" method="POST"> -->

                <div class="row justify-content-center mt--300">
                    <div class="col-lg-8">
                        <card gradient="secondary" shadow body-classes="p-lg-5">
                            <h4 class="mb-1">Want to contact me or hire?</h4>
                            <p class="mt-0">Your message is  important.</p>
                             <form id="form" accept-charset="UTF-8" action="https://usebasin.com/f/847ae8a4e61f" method="POST">
                            <base-input class="mt-5"
                                        alternative
                                        placeholder="Your name"      id="name" name="name" type="text" required=""
                                        addon-left-icon="ni ni-user-run">
                                             <input  name="name" type="text" required="" class="form-control form-control-alternative" id="exampleFormControlInput1 name" placeholder="Your name"> 
                            </base-input>
                            <base-input alternative
                                        placeholder="Email address"  id="email"
                          name="email" type="email" required=""
                                        addon-left-icon="ni ni-email-83">
                                  <input type="email" class="form-control form-control-alternative" name="email"  required="" id="exampleFormControlInput1 email" placeholder="Email address">         
                            </base-input>
                         
                               <!-- <input class="input is-large" 
                          id="email"
                          name="email" type="email" required="" placeholder="Enter Email Address"> -->

                            <base-input class="mb-4">
                                    <textarea class="form-control form-control-alternative" rows="4"
                                      id="message"
                          name="message"        cols="80" placeholder="Type a message..."></textarea>
                            </base-input>
                         
                            <button type="button success" class="btn btn-success" round block size="lg">Submit</button>
                             </form>
