    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
         <a slot="brand" class="navbar-brand mr-lg-5" href="">
                <img src="img/brand/makozi.PNG">
            </a>

           <div class="row" slot="content-header" slot-scope="{closeMenu}">
                <div class="col-6 collapse-brand">
                    <a href="">
                        <img src="img/brand/makozi_white.PNG">
                    </a>
                </div>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://twitter.com/marizu_makozi" target="_blank"
                       data-toggle="tooltip" title="Follow on Twitter">
                        <i class="fa fa-twitter-square"></i>
                        <span class="nav-link-inner--text d-lg-none">Twitter</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/makozi"
                       target="_blank" data-toggle="tooltip" title="Star  on Github">
                        <i class="fa fa-github"></i>
                        <span class="nav-link-inner--text d-lg-none">Github</span>
                    </a>
                </li>
                <li class="nav-item">
                     <a class="nav-link nav-link-icon" href="https://www.linkedin.com/in/makozi-marizu-137258112/"
                       target="_blank" data-toggle="tooltip" title="Add on LinkedIn">
                ...
                <li class="nav-item d-none d-lg-block ml-lg-4">
                     ...
                     <router-link to="/landing" title="Contact">
                             <a href="" target="_blank"
                       class="btn btn-success btn-icon">
                <span class="btn-inner--icon">
                  <i class="fa fa-address-book mr-2"></i>
                </span>
                        <span class="nav-link-inner--text">Hello</span>
                    </a>
                        </router-link>
                    <!-- <a href="" target="_blank"
                       class="btn btn-success btn-icon">
